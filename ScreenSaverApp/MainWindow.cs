...
namespace ScreenSaverApp
{
    ...
    {
        private ScreenSaverWindow[] _windows = new ScreenSaverWindow[2];
        ...
        public MainWindow()
        {
            ...
            btnDisplay1.Click += btnDisplay1_Click;
            btnDisplay2.Click += btnDisplay2_Click;

            miDisplay1.Click += miDisplay1_Click;
            miDisplay2.Click += miDisplay2_Click;
            miExit.Click += miExit_Click;

            niIcon.MouseClick += niIcon_MouseClick; ;
        }
        ...
        private void miDisplay1_Click(object sender, EventArgs e)
        {
            DisplayScreenSaver(1);
        }

        private void miDisplay2_Click(object sender, EventArgs e)
        {
            DisplayScreenSaver(0);
        }
        ...
        private void DisplayScreenSaver(int screenIndex)
        {
            ClearWindows();

            if (_windows[screenIndex] != null)
            {
                return;

                // _windows[screenIndex].Dispose();
                // _windows[screenIndex] = null;
                // return;
            }
            ...
            SetWindowPos(
                window.Handle,
                IntPtr.Zero, // (IntPtr)SpecialWindowHandles.HWND_TOP
                bounds.Left,
                bounds.Top,
                bounds.Width,
                bounds.Height,
